...
namespace Infrastructure
{
    ...
    public class HttpHelper
    {
        ...
        /// <returns></returns>
        public static string HttpPost(string url, string formData = null, Encoding encoding = null, int timeOut = 10000, IDictionary<string, string> header = null, string contentType = null)
        {
            if (encoding == null)
            ...
            var formDataBytes = formData == null ? new byte[0] : encoding.GetBytes(formData);
        ...
        /// <param name="encoding"></param>
        /// <returns></returns>
        public static string HttpGet(string url, Encoding encoding = null, IDictionary<string, string> header = null, string contentType = null)
        {
            if (encoding == null)
                encoding = Encoding.UTF8;
